...
norms = create_registry('llmfoundry', 'norms', generic_type=Type[torch.nn.Module], entry_points=True, description=_norm_description)
_fc_description = 'The fully connected layers registry is used to register classes that implement fully connected layers (i.e. torch.nn.Linear).' + 'These classes should take in_features and out_features in as args, at a minimum.'
fcs = create_registry('llmfoundry', 'fcs', generic_type=Type[torch.nn.Module], entry_points=True, description=_fc_description)
_ffns_description = 'The ffns registry is used to register functions that build ffn layers.' + 'See ffn.py for examples.'
ffns = create_registry('llmfoundry', 'ffns', generic_type=Callable, entry_points=True, description=_ffns_description)
_ffns_with_norm_description = 'The ffns_with_norm registry is used to register functions that build ffn layers that apply a normalization layer.' + 'See ffn.py for examples.'
...
_attention_classes_description = 'The attention_classes registry is used to register classes that implement attention layers. See ' + 'attention.py for expected constructor signature.'
...
_attention_implementations_description = 'The attention_implementations registry is used to register functions that implement the attention operation.' + 'See attention.py for expected function signature.'
...
_param_init_fns_description = 'The param_init_fns registry is used to register functions that initialize parameters.' + 'These will be called on a module to initialize its parameters. See param_init_fns.py for examples.'
